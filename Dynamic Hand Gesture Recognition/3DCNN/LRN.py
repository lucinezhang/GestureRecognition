...
LR_model.add(Conv3D(8, (5, 5, 5), padding='valid', input_shape=input_shape, kernel_initializer='random_uniform', bias_initializer='ones'))  
...
# train the models
result = LR_model.fit(X_train, Y_train, batch_size=20, epochs=50, verbose=1, callbacks=callbacks_list, validation_split=0.0, validation_data=(X_test, Y_test), shuffle=True, class_weight=None, sample_weight=None, initial_epoch=0)
# predict samples
L = LR_model.evaluate(X_test, Y_test)
print('Test loss:', L[0])
print('Test accuracy:', L[1])
LR_model.save_weights('50_epochs_LR.h5')
